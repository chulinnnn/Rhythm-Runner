...
// Inspector-editable vertical parallax/tiling background.
// 可在 Inspector 调整的竖版视差/平铺背景。
//
// It reads the assigned sprite/settings and creates only child tile renderers; it should not overwrite gameplay UI.
// 它读取已挂图片和参数，只创建子 tile 渲染器，不覆盖玩法 UI。
