...
// Lightweight runtime components attached to generated VerticalRunner route objects.
// 挂在 VerticalRunner 生成路线对象上的轻量运行时组件。
//
// These hold route data such as beat index, banana state, parrot branch links, and pulse behavior.
// 它们保存节拍索引、香蕉状态、鹦鹉分支连接和节拍脉冲等路线数据。
