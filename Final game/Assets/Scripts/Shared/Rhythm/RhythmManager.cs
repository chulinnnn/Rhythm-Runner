...
public class RhythmManager : MonoBehaviour
{
    ...
    public bool showVisualizationToggleButton = true;
    ...
    public void SetVisualizationToggleVisible(bool visible)
    {
        showVisualizationToggleButton = visible;
        ...
        else if (visible && toggleButton != null)
        {
    ...
    private void AwardScore(RhythmTimingResult result)
    {
        ...
        // Legacy bunny runner score forwarding was removed with the archived runner.
        // Current modes own their scoring through their scene managers.
    }
    ...
    private void EnsureVisualizationUi()
    {
        ...
        if (showVisualizationToggleButton)
        {
            EnsureToggleButton(canvas.transform);
        }
        else
        {
            SetVisualizationToggleVisible(false);
        }
        EnsureEventSystem();
