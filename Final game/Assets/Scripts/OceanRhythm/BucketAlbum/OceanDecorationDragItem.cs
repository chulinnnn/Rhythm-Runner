...
// Optional drag/click behavior for Bucket Album decoration cards.
// Bucket Album 装饰卡片的可选拖拽/点击行为。
//
// It moves only the runtime item during drag and delegates equip rules back to OceanRhythmUIController.
// 它只在拖拽时移动运行时物品，并把装备规则交回 OceanRhythmUIController。
