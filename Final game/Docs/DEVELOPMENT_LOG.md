...
- **16 Apr** — Repository created; early design notes added (`d876875`, `35fc926`).
- **9 May** — In-class 2D shooter updates merged via PR #1 (`f2c023f`).

## Week of 18–24 May 2026 — Capstone folder and first runnable demo

- **18 May** — Repo reorganised: `inclass activity/`, `prototype/`, `Final game/` (`2b4d652`).
- **19 May** — Root README and design readme; in-class activity commits for 5.19 (`d60be4a`, `34745c5`).
- **21 May** — Smallest playable bunny rhythm demo (`da8cc71`); beat-aligned barriers (`7a734bd`, `176e961`).
- **25 May** — Tutorial flow added (`64d7a73`).

## Week of 25–31 May 2026 — Age bands and Advanced mode

- **26 May** — Modes for under-5 and 5–10 age bands (`970149a`).
- **27 May** — Bucket decoration slots; under-5 content milestone (`adef11c`, `337bfd3`).
- **28 May** — Advanced three-lane mode; tutorial polish for 0–5 (`4906530`, `1d52df0`).
- **29 May** — Art pass for 0–5 mode (`c189a63`).
